...
<section class="method-sec">
	<h2 class="method-sec__title">Способ оплаты</h2>

	<input type="radio" name="pay_method" id="pay_method_1">
	<label class="method" for="pay_method_1">
		<figure>
			<img src="/images/methods/money.svg" alt="money">
		</figure>
		<div class="user-content">
			<h5 class="method__name">Оплата наличными при получении</h5>
			<p>Вы оплачиваете покупку при получении (курьеру)</p>
		</div>
	</label>

	<!--input может иметь аттрибут disabled, тогде не будет выбираться этот метод-->
	<input type="radio" name="pay_method" id="pay_method_2" disabled>
	<label class="method" for="pay_method_2" title="Доступно для выбора только зарегистрированным пользователям">
		<figure>
			<img src="/images/methods/card.svg" alt="card">
		</figure>
		<div class="user-content">
			<h5 class="method__name">Оплата банковской картой онлайн</h5>
			<p>Для совершения онлайн платежа необходимо пройти процедуру регистрации. <a href="#">Зарегистрироваться</a>.</p>
		</div>
	</label>
...
<section class="method-sec">
	...
	<label class="method" for="deliv_method_1">
		...
		<div class="user-content">
			<h5 class="method__name">Доставка курьером (Москва, в пределах МКАД)</h5>
			<p>Срок доставки от 1 до 3 дней. Доставка осуществляется в течение дня с 10.00 до 19.00. Только для розничных покупателей.</p>
			<br>
	...
	<label class="method" for="deliv_method_2">
		...
		<div class="user-content">
			<h5 class="method__name">Доставка курьером (Москва, за МКАД)</h5>
			<p>Срок доставки от 1 до 3 дней. Доставка осуществляется в течение дня с 10.00 до 19.00. Только для розничных покупателей.</p>
			<br>
			<strong>Стоимость доставки 6 000 рублей.</strong>
		</div>
	</label>
